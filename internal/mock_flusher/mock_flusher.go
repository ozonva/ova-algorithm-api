...
func (m *MockFlusher) Flush(algorithms []algorithm.Algorithm) []algorithm.Algorithm {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Flush", algorithms)
	ret0, _ := ret[0].([]algorithm.Algorithm)
	return ret0
}

// Flush indicates an expected call of Flush.
func (mr *MockFlusherMockRecorder) Flush(algorithms interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Flush", reflect.TypeOf((*MockFlusher)(nil).Flush), algorithms)
}
